...
//        MEMBER_ID = 1L;
    ...
    private ScheduleCreationRequest createScheduleCreation() {
        return new ScheduleCreationRequest("title", LocalDate.of(2021, 12, 1), LocalDate.of(2021, 12, 3), List.of("activity", "food"),
                List.of(new DailyScheduleSpotCreationRequest(11L, "address1", "roadAddress1", "불국사1", new Position(37.1234, 125.3333), LocalDate.of(2021, 12, 1), 1),
                        new DailyScheduleSpotCreationRequest(21L, "address2", "roadAddress2", "불국사2", new Position(37.1234, 125.3333), LocalDate.of(2021, 12, 1), 2),
                        new DailyScheduleSpotCreationRequest(31L, "address3", "roadAddress3", "불국사3", new Position(37.1234, 125.3333), LocalDate.of(2021, 12, 1), 3),
                        new DailyScheduleSpotCreationRequest(41L, "address4", "roadAddress4", "불국사4", new Position(37.1234, 125.3333), LocalDate.of(2021, 12, 2), 1),
                        new DailyScheduleSpotCreationRequest(51L, "address5", "roadAddress5", "불국사5", new Position(37.1234, 125.3333), LocalDate.of(2021, 12, 2), 2),
                        new DailyScheduleSpotCreationRequest(61L, "address6", "roadAddress6", "불국사6", new Position(37.1234, 125.3333), LocalDate.of(2021, 12, 2), 3),
                        new DailyScheduleSpotCreationRequest(71L, "address7", "roadAddress7", "불국사7", new Position(37.1234, 125.3333), LocalDate.of(2021, 12, 3), 1),
                        new DailyScheduleSpotCreationRequest(81L, "address8", "roadAddress8", "불국사8", new Position(37.1234, 125.3333), LocalDate.of(2021, 12, 3), 2)
                ));
    }
...
//        assertThat(memberNicknames).containsExactly("henry");
    ...
    void modifySpots() {
        ...
        ScheduleModificationRequest scheduleModificationRequest = new ScheduleModificationRequest("updated Title", List.of("NATURE"),
                List.of(
                        new DailyScheduleSpotCreationRequest(5L, "address1", "roadAddress1", "불국사1", new Position(37.1234, 125.3333), LocalDate.of(2021, 12, 22), 1),
                        new DailyScheduleSpotCreationRequest(6L, "address2", "roadAddress2", "불국사2", new Position(37.1234, 125.3333), LocalDate.of(2021, 12, 22), 2),
                        new DailyScheduleSpotCreationRequest(7L, "address3", "roadAddress3", "불국사3", new Position(37.1234, 125.3333), LocalDate.of(2021, 12, 23), 1),
                        new DailyScheduleSpotCreationRequest(8L, "address4", "roadAddress4", "불국사4", new Position(37.1234, 125.3333), LocalDate.of(2021, 12, 23), 2),
                        new DailyScheduleSpotCreationRequest(9L, "address5", "roadAddress5", "불국사5", new Position(37.1234, 125.3333), LocalDate.of(2021, 12, 24), 1),
                        new DailyScheduleSpotCreationRequest(11L, "address6", "roadAddress6", "불국사6", new Position(37.1234, 125.3333), LocalDate.of(2021, 12, 24), 2),
                        new DailyScheduleSpotCreationRequest(12L, "address7", "roadAddress7", "불국사7", new Position(37.1234, 125.3333), LocalDate.of(2021, 12, 24), 3)
                ));
